    ...
    <section id="where-to-find-us" className="py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-5 p-6 rounded-3xl bg-zinc-50 border border-zinc-100 transition-all hover:shadow-xl hover:shadow-zinc-200/50 group">
                ...
                <div>
                  ...
                  <p className="text-zinc-500 font-medium">C. 101 732, Mercedes, Provincia de Buenos Aires</p>
                </div>
              </div>
          ...
          >
            <iframe 
              src="https://maps.google.com/maps?q=Zingueria%20Mercedes,%20C.%20101%20732,%20Mercedes,%20Provincia%20de%20Buenos%20Aires&t=&z=15&ie=UTF8&iwloc=&output=embed" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
